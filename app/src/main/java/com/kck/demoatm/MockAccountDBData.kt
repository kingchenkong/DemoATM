...
// MOCK 1
const val MOCK_1_ACCOUNT_SN = "001-9876-5432"
...
fun getAccountDBMock1(): AccountDB {
    return AccountDB(
        0,
        serialNumber = MOCK_1_ACCOUNT_SN,
...
// MOCK 2
const val MOCK_2_ACCOUNT_SN = "065-6665-4088" // 065 666 54088
...
fun getAccountDBMock2(): AccountDB {
    return AccountDB(
        0,
        serialNumber = MOCK_2_ACCOUNT_SN,
...
// MOCK 3
const val MOCK_3_ACCOUNT_SN = "014-3525-9891"
...
fun getAccountDBMock3(): AccountDB {
    return AccountDB(
        0,
        serialNumber = MOCK_3_ACCOUNT_SN,
